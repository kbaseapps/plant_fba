...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'plant_fba'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from plant_fba.plant_fbaImpl import plant_fba  # noqa @IgnorePep8
impl_plant_fba = plant_fba(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'plant_fba'
